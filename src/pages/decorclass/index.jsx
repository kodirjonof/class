  ...
  return (
    ...
    <div className='classes'>
        <div className="classes_header">
         ...
         <p className="classes_info">Приветствуем на сайте "Decorclass" — вашем надежном источнике стильных и функциональных декоративных панелей из ПВХ! Наши уникальные дизайны и высокое качество материалов делают наши панели идеальным решением для трансформации интерьера.
